...
*/}}
{{- define "copd.labels" -}}
helm.sh/chart: {{ include "copd.chart" . }}
{{ include "copd.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
Selector labels
*/}}
{{- define "copd.selectorLabels" -}}
app.kubernetes.io/name: {{ include "copd.name" . }}
...
*/}}
{{- define "copd.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "copd.fullname" .) .Values.serviceAccount.name }}
{{- else }}
...
*/}}
{{- define "copd.global.configuration" -}}
...
*/}}
{{- define "copd.global.environments" -}}
- name: APP_VERSION
...
- name: ROOT_DOMAIN
  value: {{ .Values.global.environments.root.domain | default "copd.w3x.app" | quote }}
- name: ROOT_SUBJECT
  value: {{ .Values.global.environments.root.subject | default "root@copd.w3x.app" | quote }}
- name: PLATFORM_URL
...
- name: CLIENT_BASE_URL
  value: {{ .Values.global.environments.frontend.baseUrl | default "https://copd.w3x.app" | quote }}
- name: CLIENT_ASSETS_URL
  value: {{ .Values.global.environments.frontend.assetsUrl | default "https://assets.copd.w3x.app" | quote }}
# **********************
# Logging Services
# **********************
# Sentry
...
- name: REDIS_PREFIX
  value: {{ .Values.global.environments.redis.prefix | default "copd" | quote }}
- name: REDIS_PASSWORD
...
- name: MONGO_PREFIX
  value: {{ .Values.global.environments.mongo.prefix | default "copd" | quote }}
- name: MONGO_USER
...
# Nats
- name: NATS_USER
  value: {{ .Values.global.environments.nats.user | default "copd" | quote }}
- name: NATS_PASS
  value: {{ .Values.global.environments.nats.pass | default "copd" | quote }}
- name: NATS_TIMEOUT
...
- name: GOOGLE_REDIRECT_URI
  value: {{ .Values.global.environments.google.client.redirectUri | default "https://copd.w3x.app/oauth" | quote }}
# **********************
# Telemetry Services
# **********************
# OpenTelemetry
