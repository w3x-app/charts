...
*/}}
{{- define "rsch.labels" -}}
helm.sh/chart: {{ include "rsch.chart" . }}
{{ include "rsch.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
Selector labels
*/}}
{{- define "rsch.selectorLabels" -}}
app.kubernetes.io/name: {{ include "rsch.name" . }}
...
*/}}
{{- define "rsch.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "rsch.fullname" .) .Values.serviceAccount.name }}
{{- else }}
...
*/}}
{{- define "rsch.global.configuration" -}}
...
*/}}
{{- define "rsch.global.environments" -}}
- name: APP_VERSION
...
- name: ROOT_DOMAIN
  value: {{ .Values.global.environments.root.domain | default "rsch.w3x.app" | quote }}
- name: ROOT_SUBJECT
  value: {{ .Values.global.environments.root.subject | default "root@rsch.w3x.app" | quote }}
- name: PLATFORM_URL
...
- name: CLIENT_BASE_URL
  value: {{ .Values.global.environments.frontend.baseUrl | default "https://rsch.w3x.app" | quote }}
- name: CLIENT_ASSETS_URL
  value: {{ .Values.global.environments.frontend.assetsUrl | default "https://assets.rsch.w3x.app" | quote }}
# **********************
# Logging Services
# **********************
# Sentry
...
- name: REDIS_PREFIX
  value: {{ .Values.global.environments.redis.prefix | default "rsch" | quote }}
- name: REDIS_PASSWORD
...
- name: MONGO_PREFIX
  value: {{ .Values.global.environments.mongo.prefix | default "rsch" | quote }}
- name: MONGO_USER
...
# Nats
- name: NATS_USER
  value: {{ .Values.global.environments.nats.user | default "rsch" | quote }}
- name: NATS_PASS
  value: {{ .Values.global.environments.nats.pass | default "rsch" | quote }}
- name: NATS_TIMEOUT
...
- name: GOOGLE_REDIRECT_URI
  value: {{ .Values.global.environments.google.client.redirectUri | default "https://rsch.w3x.app/oauth" | quote }}
# **********************
# Telemetry Services
# **********************
# OpenTelemetry
